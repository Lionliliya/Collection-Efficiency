...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            writeToFile.printf("\n============================================================================================================================");
            writeToFile.println();
            writeToFile.printf("%1s%8s%13s%15s%15s%19s%22s%22s", "ArrayList", addToArrayList1000K, getByIndexArrayList1000K, removeArrayList1000K, containsArrayList1000K, populateArrayList1000K, iteratorAddArrayList1000K, iteratorRMArrayList1000K);
            writeToFile.println();
            writeToFile.printf("%1s%7s%13s%15s%15s%19s%22s%22s", "LinkedList", addToLinkedList1000K, getByIndexLinkedList1000K, removeLinkedList1000K, containsLinkedList1000K, populateLinkedList1000K, iteratorAddLinkedList1000K, iteratorRMlinkedList1000K);
            writeToFile.println();
            writeToFile.printf("%1s%10s%13s%15s%15s%19s", "HashSet", addHashSet1000K, " ", removeHashSet1000k, containsHashSet1000k, populateHashSet1000k);
            writeToFile.println();
            writeToFile.printf("%1s%10s%13s%15s%15s%19s", "TreeSet", addTreeSet1000K, " ", removeTreeSet1000k, containstreeSet1000k, populateTreeSet1000k);
            writeToFile.printf("\n============================================================================================================================");
